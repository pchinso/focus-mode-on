...
- [ ] git action: merge v1.1 branch to main.
- [X] git action: new branch v1.2
- [ ] feat: in branch v1.2 implement specs_v12.md features (in progress: full-text search, stale smart list, due dates + agenda view, insights panel, PWA/offline basics done; priorities, drag-and-drop, multi-select, notes/quick-capture pending)
