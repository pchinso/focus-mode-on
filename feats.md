...
- [X] feat: in branch v1.2 implement specs_v12.md features (done: full-text search, stale smart list, due dates + agenda view, insights panel, PWA/offline basics, task priorities, multi-select bulk actions, quick-capture inbox, task notes, drag-and-drop reorder + re-parent)
