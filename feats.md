...
- [ ] feat: in branch v1.2 implement specs_v12.md features (in progress: full-text search, stale smart list, due dates + agenda view, insights panel, PWA/offline basics, task priorities done; drag-and-drop, multi-select, notes/quick-capture pending)
